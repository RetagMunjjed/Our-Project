        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                "Services",
                style: TextStyle(color: AppColor.pink, fontSize: 25),
              ),
              SizedBox(height: 20),
              Wrap(
                spacing: 10,
                ...
                children: services.map((service) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      height: 40,
                      child: Card(
                        color: isSelected ? AppColor.pink : Colors.white,
                        child: Center(
                          child: Text(
                            service,
                            style: TextStyle(
              ...
              Text("Table time for rest",
                  style: TextStyle(color: AppColor.pink, fontSize: 20)),
              SizedBox(
                height: 10,
              ),
              Row(
