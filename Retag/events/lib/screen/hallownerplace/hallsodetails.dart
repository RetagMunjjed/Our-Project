...
class Hallsodetails extends StatefulWidget {
  const Hallsodetails({super.key});

  @override
  State<Hallsodetails> createState() => _HallsodetailsState();
}

class _HallsodetailsState extends State<Hallsodetails> {
  File? _mainImage;
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            // باقي التفاصيل تماماً كما أرسلتها
            Row(
              children: [
                Text("Paris Halls",
                    style:
                          ...
                          return AlertDialog(
                            ...
                            content: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "Add new location of the hall",
                                    style: TextStyle(fontSize: 16),
                                  ),
                                  SizedBox(height: 10),
                                  TextField(
                                    decoration: InputDecoration(
                                      isDense: true, // 👈 تصغير الحقل
                                      contentPadding: EdgeInsets.all(10),
                                      border: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(8),
                                        borderSide: BorderSide(
                          ...
                          return AlertDialog(
                            ...
                            content: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "Add new number guset of the hall",
                                    style: TextStyle(fontSize: 16),
                                  ),
                                  SizedBox(height: 10),
                                  TextField(
