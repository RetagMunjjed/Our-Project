...
class Cafeodetails extends StatefulWidget {
  const Cafeodetails({super.key});

  @override
  State<Cafeodetails> createState() => _CafeodetailsState();
}

class _CafeodetailsState extends State<Cafeodetails> {
  File? _mainImage;
                          ...
                          return AlertDialog(
                            ...
                            content: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "Add new number guset of the cafe",
                                    style: TextStyle(fontSize: 16),
                                  ),
                                  SizedBox(height: 10),
                                  TextField(
