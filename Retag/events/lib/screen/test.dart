import 'package:events/screen/events.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 5), () {
      Navigator.of(context)
          .pushReplacement(MaterialPageRoute(builder: (context) => Events()));
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // body: Center(child: FSAcaleAnimation(child:Image.asset("images/amal.jpg"),duration:Duration(seconds: 2),scale:1.5,curve:Curves.easeIn),),
    );
  }
}
