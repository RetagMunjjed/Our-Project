...
import 'package:events/models/task_model.dart';
    ...
    try {
      ...
      final response = await api.get(
        EndPoint.getMusicDataEndPoint(
          CachHelper().getData(key: ApiKey.id),
        ),
      );
      ...
      emit(GetMusicFailure(message: e.erroeModel.message));
    }
  }
