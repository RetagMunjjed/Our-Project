...
import 'package:untitled10/modules/details_of_type_food.dart';

class DetailsOfFood extends StatelessWidget {
  const DetailsOfFood({super.key});
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            IconButton(
                                onPressed: (){
                             Navigator.push(context, MaterialPageRoute(builder: (context)=>DetailsOfTypeFood()));
                                },
