...
import 'package:untitled10/modules/houses.dart';
import 'package:untitled10/modules/mmusic.dart';
                  ...
                  child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => ChooseTypeOfFood()));
                      },
                      child: Card(
                        child: Row(
              ...
              children: [
                Container(
                  ...
                  child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => ChooseTypeOfDecoration()));
                      },
                      child: Card(
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
